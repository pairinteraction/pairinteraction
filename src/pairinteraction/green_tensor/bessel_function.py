...
def cached_bessel_function_0(z: complex) -> complex:
    return scipy_bessel_function(0, z)


@lru_cache(maxsize=100_000)
def cached_bessel_function_1(z: complex) -> complex:
    return scipy_bessel_function(1, z)


@lru_cache(maxsize=100_000)
def cached_bessel_function_2(z: complex) -> complex:
    return scipy_bessel_function(2, z)
    # for even a bit more speedup:
    # return (2.0 / z) * cached_bessel_function_1(z) - cached_bessel_function_0(z)  # noqa: ERA001
