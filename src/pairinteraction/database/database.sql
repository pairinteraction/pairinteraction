...
CREATE TABLE states (
    ...
    -- General quantum numbers
    --
    -- The quantum numbers of the individual constituents
    ...
    -- Quantum numbers specific to the LS coupling scheme
    ...
    -- Quantum numbers specific to the jj coupling scheme
    ...
    -- Quantum numbers specific to the FJ coupling scheme
