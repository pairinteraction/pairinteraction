...
def build_application_palette() -> QPalette:
    ...
    palette.setColor(QPalette.ColorRole.Midlight, QColor("#cbd5e1"))
    palette.setColor(QPalette.ColorRole.Mid, QColor("#767676"))
    palette.setColor(QPalette.ColorRole.Dark, QColor("#1e293b"))
