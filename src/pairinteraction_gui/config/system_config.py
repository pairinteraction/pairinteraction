...
class SystemConfig(BaseConfig):
    ...
    def setupEField(self) -> None:
        ...
        self.Ex = RangeItem(self, "Ex", (-999, 999), unit="V/cm", long_label="electric field in x-direction")
        self.Ey = RangeItem(self, "Ey", (-999, 999), unit="V/cm", long_label="electric field in y-direction")
        self.Ez = RangeItem(self, "Ez", (-999, 999), unit="V/cm", long_label="electric field in z-direction")
    ...
    def setupBField(self) -> None:
        ...
        self.Bx = RangeItem(self, "Bx", (-999, 999), unit="Gauss", long_label="magnetic field in x-direction")
        self.By = RangeItem(self, "By", (-999, 999), unit="Gauss", long_label="magnetic field in y-direction")
        self.Bz = RangeItem(self, "Bz", (-999, 999), unit="Gauss", long_label="magnetic field in z-direction")
