...
class PairinteractionModule(Protocol):
    ...
    GreenTensorInterpolator: type[pi.GreenTensorInterpolator]
    GreenTensorFreeSpace: type[pi.GreenTensorFreeSpace]
    GreenTensorSurface: type[pi.GreenTensorSurface]
    GreenTensorCavity: type[pi.GreenTensorCavity]
