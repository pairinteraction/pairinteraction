...
def test_c3_with_system(pi_module: PairinteractionModule, system_pair_sample: SystemPair) -> None:
    """Test whether the C3 coefficient with a given system is calculated correctly."""
    ket_tuple_list = [
        (pi_module.KetAtom("Rb", n=61, l=0, j=0.5, m=0.5), pi_module.KetAtom("Rb", n=61, l=1, j=1.5, m=0.5)),
        (pi_module.KetAtom("Rb", n=61, l=1, j=1.5, m=0.5), pi_module.KetAtom("Rb", n=61, l=0, j=0.5, m=0.5)),
    ]
...
@pytest.mark.filterwarnings("ignore::DeprecationWarning")
def test_c3_create_system(pi_module: PairinteractionModule) -> None:
...
@pytest.mark.filterwarnings("ignore::DeprecationWarning")
def test_c6_with_system(pi_module: PairinteractionModule, system_pair_sample: SystemPair) -> None:
    """Test whether the C6 coefficient with a given system is calculated correctly."""
    ket_atom = pi_module.KetAtom(species="Rb", n=61, l=0, j=0.5, m=0.5)
...
@pytest.mark.filterwarnings("ignore::DeprecationWarning")
def test_c6_create_system(pi_module: PairinteractionModule) -> None:
