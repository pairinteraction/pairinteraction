...
def test_static_green_tensor_interpolator(
    ...
    gti.set_constant(1, 1, tensor, tensor_unit)

    tensor_spherical = gti.get(1, 1, omega, unit=tensor_unit, scaled=True, coordinates="spherical")
...
def test_system_atom_green_tensor_interpolator(
    ...
    expected_shift = green_tensor_zz * abs(dipole) ** 2
