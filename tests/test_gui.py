...
def atest_main_window_basic(qtbot: "QtBot", window_starkmap: "MainWindow") -> None:
...
def _test_calculate_page(
    ...
    compare_to_reference(REFERENCE_PATHS[reference_name], energies, np.array(results.ket_overlaps))
