...
public:
    ...
    StateOne();
    StateOne(std::string element, int n, int l, double j, double m);
    StateOne(idx_t idx, int n, int l, double s, double j, double m);
    StateOne(idx_t idx, int n, int l, double j, double m);
    StateOne(int n, int l, double j, double m);
    StateOne(int n, int l, double s, double j, double m);
...
public:
    ...
    std::array<int, 2> n, l;
    std::array<double, 2> s, j, m;

    StateTwo();
    StateTwo(std::array<std::string, 2> element, std::array<int, 2> n, std::array<int, 2> l, std::array<double, 2> j, std::array<double, 2> m);
    StateTwo(const StateOne &s1, const StateOne &s2);
    StateTwo(idx_t idx, std::array<int, 2> n, std::array<int, 2> l, std::array<double, 2> s, std::array<double, 2> j, std::array<double, 2> m);
    StateTwo(std::array<int, 2> n, std::array<int, 2> l, std::array<double, 2> j, std::array<double, 2> m);
