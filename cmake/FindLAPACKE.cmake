...
if(LAPACK_FOUND)
    ...
    if(LAPACKE_LIBRARY)
        set_property(TARGET LAPACK::LAPACK APPEND PROPERTY INTERFACE_LINK_LIBRARIES "${LAPACKE_LIBRARY}")
    endif()
    if(LAPACKE_INCLUDE_DIR)
        set_property(TARGET LAPACK::LAPACK APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES "${LAPACKE_INCLUDE_DIR}")
    endif()
