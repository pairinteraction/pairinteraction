...
class DiamagnetismTest(unittest.TestCase):
    def test_diamagnetism_isotropy(self):
        ...
        self.assertAlmostEqual(energies_z[i1] - state_one.getEnergy(), 19.729554603372435, places=4)
        self.assertAlmostEqual(energies_z[i2] - state_one.getEnergy(), 0.1120907536969753, places=4)
